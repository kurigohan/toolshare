...
urlpatterns = patterns('',
    ...
    url(r'^tool/edit_tool/(?P<tool_id>\d+)/$', ShareView.edit_tool, name='edit_tool'),
    url(r'^tool/borrow_tool/(?P<tool_id>\d+)/$', ShareView.borrow_tool, name='borrow_tool'),
    url(r'^tool/return_tool/(?P<tool_id>\d+)/$', ShareView.return_tool, name='return_tool'),
